...
default
{
    ...
    touch_start(integer total_number)
    {
        ...
        {
            llOwnerSay("Você já está registrado como jogador " + llList2String(CORES_NOMES, index_existente) + ".");
            return;
        }
        ...
        {
            llSay(0, "O jogo já está cheio com 4 jogadores.");
        }
    }
    ...
    listen(integer channel, string name, key id, string message)
    {
        ...
        else if (comando == "PECA_MOVIDA")
        {
            ...
            if (id_cor == turno_atual)
            {
                ...
                if (dado_rolado == 6)
                {
                    llSay(0, "Você tirou 6 e joga novamente!");
                    aguardando_movimento = FALSE;
                    dado_rolado = 0;
                }
                else
